...
export declare const ContactShadows: React.ForwardRefExoticComponent<Pick<Omit<import("@react-three/fiber").Node<THREE.Group, typeof THREE.Group>, import("@react-three/fiber").NonFunctionKeys<{
