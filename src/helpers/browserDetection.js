...
export var isSafari = /^((?!chrome|android).)*safari/i.test(window.navigator.userAgent);

// Internet Explorer 6-11
export var isIE = window.navigator.userAgent.indexOf("Edge") > -1;

// Edge 20+
export var isEdge = !isIE && !!window.StyleMedia;

// Chrome 1+
export var isChromium = window.chrome;

export var isIOSChrome = window.navigator.userAgent.match("CriOS");

export var isChrome = isChromium !== null &&
...
export var isMobile = false; //initiate as false
// device detection
