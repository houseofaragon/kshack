...
export const isIE = window.navigator.userAgent.indexOf("Edge") > -1;
...
export const isIOSChrome = window.navigator.userAgent.match("CriOS");

export const isChrome = isChromium !== null &&
...
export const isMobile = false; //initiate as false
// device detection
