<template>
  <div class="hello">
    ...
    <div class="comments">
        ...
        <div>
            <div v-show="filteredEntries && filteredEntries.length > 0">
...
export default defineComponent({
  ...
  methods: {
    ...
    sortAsc () {
      return this.filteredEntries.sort((a, b) => a.API > b.API ? 1 : -1)
    },
    sortDesc () {
      return this.filteredEntries.sort((a, b) => a.API < b.API ? 1 : -1)
    },
    filterEntries () {
      ...
      this.filteredEntries = this.entries.filter(entry => entry.Category === this.searchQuery)
    }
  }
})
</script>
